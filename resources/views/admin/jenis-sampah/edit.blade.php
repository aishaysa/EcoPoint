...
@section('page_title', 'Edit Jenis Sampah')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div style="display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:12px; margin-bottom:24px;">
        <div>
            <h1 style="font-size:24px; font-weight:700; color:#1f2937; margin:0;">Edit Jenis Sampah</h1>
            <p style="font-size:14px; color:#6b7280; margin:4px 0 0 0;">Ubah data jenis sampah yang sudah ada</p>
        </div>
            ...
            <div style="padding:20px;">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <div style="display:flex; align-items:stretch; width:100%;">
                        <input type="number" id="poin_per_kg" name="poin_per_kg" 
                               value="{{ old('poin_per_kg', $jenisSampah->poin_per_kg) }}"
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                              ...
                              class="form-input"
                              style="width:100%; padding:12px 16px; border:2px solid #d1d5db; border-radius:8px; font-size:14px; font-weight:500; color:#1f2937; background:#fff; outline:none; box-sizing:border-box; resize:vertical; font-family:inherit;">{{ old('deskripsi', $jenisSampah->deskripsi) }}</textarea>
                </div>
