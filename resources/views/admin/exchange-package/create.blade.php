...
<div class="container mx-auto px-4 py-6">
    ...
    <div style="display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:12px; margin-bottom:24px;">
        <div>
            <h1 style="font-size:24px; font-weight:700; color:#1f2937; margin:0;">Tambah Paket Penukaran</h1>
            <p style="font-size:14px; color:#6b7280; margin:4px 0 0 0;">Buat paket baru untuk penukaran poin ke uang tunai</p>
        </div>
    ...
    <form action="{{ route('admin.exchange-package.store') }}" method="POST" id="packageForm">
        @csrf
                ...
                <div>
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                        <label style="cursor:pointer; display:block; position:relative;">
                            ...
                            <div class="status-card status-active" data-value="1" style="display:flex; align-items:center; justify-content:center; gap:8px; padding:12px 16px; border:2px solid #d1d5db; border-radius:8px; background:#fff; font-size:14px; font-weight:700; color:#4b5563; transition:all 0.2s;">
                        ...
                        <label style="cursor:pointer; display:block; position:relative;">
                            <input type="radio" name="is_active" value="0" 
                                   ...
                                   style="position:absolute; opacity:0; pointer-events:none;">
                            <div class="status-card status-inactive" data-value="0" style="display:flex; align-items:center; justify-content:center; gap:8px; padding:12px 16px; border:2px solid #d1d5db; border-radius:8px; background:#fff; font-size:14px; font-weight:700; color:#4b5563; transition:all 0.2s;">
                                <svg style="width:16px; height:16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
