            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        ...
                        <form action="{{ route('admin.titik-kumpul.destroy', $item->id) }}" 
                              method="POST" 
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/50 backdrop-blur-sm transition-all duration-300">
    <div id="deleteModalContent" class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all duration-300 scale-95 opacity-0 p-6">
        ...
        <h3 class="text-lg font-bold text-center text-gray-800 mb-2">Hapus Titik Kumpul?</h3>
        <p class="text-sm text-center text-gray-600 mb-6">
            Apakah Anda yakin ingin menghapus titik kumpul <span id="modalNama" class="font-semibold text-gray-800"></span>?
...
<script>
    ...
    (function() {
        ...
        cancelBtn.addEventListener('click', function() {
            ...
            hideModal();
            showCancelToast('Penghapusan titik kumpul "' + nama + '" dibatalkan');
        });
