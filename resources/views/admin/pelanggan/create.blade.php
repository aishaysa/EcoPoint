...
<div class="container mx-auto px-4 py-6">
    ...
    <div style="display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:12px; margin-bottom:24px;">
        <div>
            <h1 style="font-size:24px; font-weight:700; color:#1f2937; margin:0;">Tambah Pelanggan</h1>
            <p style="font-size:14px; color:#6b7280; margin:4px 0 0 0;">Tambahkan data pelanggan baru ke sistem</p>
        </div>
            ...
            <div style="padding:20px;">
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="3"
                              ...
                              class="form-input"
                              style="width:100%; padding:12px 16px; border:2px solid #d1d5db; border-radius:8px; font-size:14px; font-weight:500; color:#1f2937; background:#fff; outline:none; box-sizing:border-box; resize:vertical; font-family:inherit;">{{ old('alamat') }}</textarea>
                </div>
