...
Route::get('/dashboard', [UserDashboardController::class, 'home'])->name('dashboard');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // AREA ADMIN (dengan middleware auth:admin)
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::patch('titik-kumpul/{id}/toggle-status', [TitikKumpulController::class, 'toggleStatus'])
        ...
        // ============================================================
        Route::put('setoran/{id}/selesaikan', [PelangganController::class, 'selesaikanSetoran'])
        ...
        Route::resource('exchange-packages', ExchangePackageController::class)
            ->names([
                'index'   => 'exchange-package.index',
                'create'  => 'exchange-package.create',
                'store'   => 'exchange-package.store',
                'edit'    => 'exchange-package.edit',
                'update'  => 'exchange-package.update',
                'destroy' => 'exchange-package.destroy',
            ]);
        Route::post('exchange-packages/{id}/toggle', [ExchangePackageController::class, 'toggle'])
            ->name('exchange-package.toggle');
...
Route::prefix('user')->name('user.')->middleware(['auth:web'])->group(function () {
    ...
    Route::get('/transaksi/{id}', [UserDashboardController::class, 'transaksiDetail'])->name('transaksi.detail');
